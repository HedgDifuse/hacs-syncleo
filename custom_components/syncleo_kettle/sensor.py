...
async def async_setup_entry(
    ...
    if coordinator.device_info is None:
        ...
        return
    # The air conditioner also exposes its room temperature through the climate
    # entity, but a standalone sensor is handy for history/automations.
    if coordinator.is_conditioner:
        async_add_entities([CurrentTemperatureSensor(coordinator, config_entry.entry_id)])
        return
